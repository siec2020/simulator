...
{
    [SensorType("IMU Fine", new[] { typeof(ImuData) })]
    class ImuFineSensor : SensorBase
    {
        [SensorParameter]
        ...
        void Start()
        {
            ...
            using (System.IO.StreamWriter sw = System.IO.File.CreateText(System.IO.Path.Combine(path_IMU, @"IMU_file\Working\IMU_pos.txt")))
            {
            }
            //Creation of the data file to add the values
            using (System.IO.StreamWriter sw = System.IO.File.CreateText(System.IO.Path.Combine(path_IMU, @"IMU_file\Working\IMU_orientation.txt")))
            {
            }
            Task.Run(Publisher);
        }
        ...
        public override void OnVisualize(Visualizer visualizer)
        {
            ...
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(System.IO.Path.Combine(path_IMU, @"IMU_file\Working\IMU_pos.txt"), true))
            {
                file.WriteLine((data.Position).ToString());
            }
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(System.IO.Path.Combine(path_IMU, @"IMU_file\Working\IMU_orientation.txt"), true))
            {
                file.WriteLine((data.Orientation).ToString());
            }
        }
